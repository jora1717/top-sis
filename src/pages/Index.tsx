    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="lokacija" className="scroll-mt-36 md:scroll-mt-28 border-t border-border py-12">
        <div className="container">
          ...
          <a href="https://maps.app.goo.gl/C5Aa3HVNymQHat8v7" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 mb-4 text-muted-foreground hover:text-foreground transition-colors">
          ...
          <div className="overflow-hidden rounded-xl border border-border">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2832.0!2d20.4335!3d44.7856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475a6f1c1c1c1c1d%3A0x1234567890abcdef!2sStrugarska%201a%2C%20%C4%8Cukari%C4%8Dka%20padina!5e0!3m2!1ssr!2srs"
              width="100%"
              height="350"
              style={{ border: 0 }}
              allowFullScreen
