      ...
      <footer className="border-t border-border bg-muted py-12">
        <div className="container space-y-8">
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-border bg-card p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">+381 64 5747 478</p>
                <p className="text-sm text-muted-foreground">info@topsis.rs</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-xl border border-border bg-card p-4">
              <div>
                <p className="text-sm font-bold mb-2">Zapratite nas!</p>
                <div className="flex items-center gap-4">
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors duration-150 hover:text-foreground" aria-label="Instagram">
                  ...
                  <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors duration-150 hover:text-foreground" aria-label="TikTok">
                  ...
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors duration-150 hover:text-foreground" aria-label="Facebook">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-border bg-card p-4">
              ...
              <div>
                <p className="text-sm font-bold">Radno vreme</p>
                <p className="text-sm text-muted-foreground">Svakog dana</p>
                <p className="text-sm text-muted-foreground">07:00 - 23:30</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center text-sm text-muted-foreground space-y-1">
            ...
            <p className="text-xs">Strugarska 1a · Cene su izražene u RSD. Dostava se naplaćuje dodatno.</p>
            <button
